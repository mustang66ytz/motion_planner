...
def quaternion_2_matrix(translation, quaternion):
    ma = tf.transformations.quaternion_matrix(quaternion)
    ma[:3, -1] = translation
    return ma
...
def get_picture_point(target_pose, camera):
